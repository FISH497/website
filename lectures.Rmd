...
Please note that the schedule may change depending on student input and instructor responsiveness.
...
week_lecs$L6 <- workflows
## week 3: Jan 18-22
week_lecs$L7 <- holiday_1
week_lecs$L8 <- working_with_data
week_lecs$L9 <- data_ingest
## week 4: Jan 25-29
week_lecs$L10 <- metadata
week_lecs$L11 <- data_cleaning
...
## week 6: Feb 8-12
week_lecs$L16 <- visualization
week_lecs$L17 <- analysis
week_lecs$L18 <- packages_1
## week 7: Feb 15-19
week_lecs$L19 <- holiday_2
week_lecs$L20 <- packages_2
week_lecs$L21 <- markdown_1
## week 8: Feb 22-26
week_lecs$L22 <- guest_stawitz
week_lecs$L23 <- markdown_2
week_lecs$L24 <- markdown_3
## week 9: Mar 1-5
week_lecs$L25 <- shiny_1
week_lecs$L26 <- shiny_2
week_lecs$L27 <- code_reviews
## week 10: Mar 8-12
week_lecs$L28 <- ethics
week_lecs$L29 <- future
week_lecs$L30 <- wrap_up
```
