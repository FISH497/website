...
## &nbsp; {data-background=twitter_data_cleaning.png data-background-size=85% .futnote}
...
## &nbsp; {data-background=tt_logo.png data-background-size=100% .futnote}

[TidyTuesday](https://github.com/rfordatascience/tidytuesday)


## &nbsp; {data-background=siple_tt_post.jpeg data-background-size=75% .futnote}
