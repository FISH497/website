...
## &nbsp; {data-background=data_sci_overview.png data-background-size=90%}
...
## {data-background=leek_peng_Q.png data-background-size=80% .futnote}
...
eg, wearing a mask reduces the spread of COVID
...
eg, using weather to predict recreational fishing effort
...
eg, experimental analysis of temperature effects on oyster growth
