...
By default, headers and footers will not be displayed on the first page of your PDF document. If you want wish to show our footer on the front page, we must include an additional line `\fancypagestyle{plain}{\pagestyle{fancy}}`.
