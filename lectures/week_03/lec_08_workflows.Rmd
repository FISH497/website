...
* Team member makes changes on the `feature` branch

> - Commits are pushed to the developer's own remote copy

> - Team member opens a pull request from the `feature` branch to the "official" repository

> - Pull request gets approved & is merged into the original remote repository
