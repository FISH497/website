...
You are welcome to use **R Markdown** to complete this assignment, but if you'd rather not, I will also happily accept a combination of a `.R` script with your plotting code and a saved version of your figure in a format such as `.png`, `.jpg`, or `.pdf`. Click [here](../../lectures/week_07/intro_markdown.html) for an introduction to **R Markdown**.
