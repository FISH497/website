...
databases_1 <- list(
  ...
  pdf = c(""),
  rmd = "lectures/week_05/lec_13_intro_databases_1.Rmd",
...
databases_2 <- list(
  ...
  topics = c("<i>Jennifer Scheuerell</i>", "<b>Creating a database</b>", "Manipulating data", "Queries and joins", "Views & materialized views", "Backup & restore"),
  pdf = c(""),
