...
databases_1 <- list(
  ...
  topics = c("<i>Jennifer Scheuerell</i>", "<b>Intro to relational databases</b>", "SQL programming language", "PostgreSQL & its community", "Creating a database"),
  pdf = c(""),
  rmd = "",
  html = "lectures/week_05/lec_13_intro_databases_1.html",
  background = "[About PostgreSQL](https://www.postgresql.org/about/)",
  zoom = ""
)
...
databases_2 <- list(
  ...
  topics = c("<i>Jennifer Scheuerell</i>", "<b>Manipulating data</b>", "Queries and joins", "Views & materialized views", "Backup & restore"),
  pdf = c(""),
  rmd = "",
  html = "",
  background = "",
...
databases_3 <- list(
  ...
  topics = c("<i>Jennifer Scheuerell</i>", "<b>Advanced features</b>", "Stored procedures & functions", "Triggers & automation", "Foreign data wrappers"),
  pdf = c(""),
  rmd = "",
  html = "",
  background = "",
