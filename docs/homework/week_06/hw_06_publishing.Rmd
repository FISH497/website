...
This past week you saw various ways to format `.pdf` documents using **R Markdown** and some simple **LaTeX** commands. Your assignment is to create a `report` based upon the text [here](hw_06_template.Rmd) with the following attributes:
