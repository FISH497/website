...
You can see that Git responded to your command with a helpful reminder about branch names. In the not so distant past, GitHub used the term "master" to refer to the main branch of a repo. However, in light of the negative connotations of the word, that has been changed to "main", so Git is suggesting you might want to change it as well.
